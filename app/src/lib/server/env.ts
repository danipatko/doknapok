...
export const HOST = process.env.NODE_ENV === 'production' ? process.env.HOST ?? 'doknapok.szlginfo.com' : 'localhost:3000';
export const REDIS_HOST = process.env.NODE_ENV === 'production' ? 'redis://127.0.0.1:6379' : 'redis://redis:6379';
